...
shinyUI(
  ...
  navbarPage("Interactive Probabilistic Predictions",theme = shinythemes::shinytheme("united"),
             ...
             tabPanel("Home",
                      ...
                      helpText(h4("Current lead developer")),
                      helpText(HTML("<a href = 'https://researchers.adelaide.edu.au/profile/david.mcinerney'> Dr David McInerney </a>, Senior Research Associate, School of Architecture and Civil Engineering, University of Adelaide (<a href='david.mcinerney@adelaide.edu.au'>Email</a>)")),
                      helpText(h4("Contributors")),
                      helpText(HTML("<a href= 'https://researchers.adelaide.edu.au/profile/jason.hunter'> Jason Hunter </a>, PhD Candidate, School of Architecture and Civil Engineering, University of Adelaide (<a href='jason.hunter@adelaide.edu.au'>Email</a>)")),
                      helpText(HTML("<a href='https://researchers.adelaide.edu.au/profile/mark.thyer'> Dr Mark Thyer </a>, Associate Professor in Water Resources Engineering, School of Architecture and Civil Engineering, University of Adelaide (<a href='mark.thyer@adelaide.edu.au'>Email</a>)")),
                      helpText(HTML("<a href = 'https://researchers.adelaide.edu.au/profile/dmitri.kavetski'> Prof. Dmitri Kavetski </a>, Professor in Environmental Modelling, School of Architecture and Civil Engineering, University of Adelaide (<a href='dmitri.kavetski@adelaide.edu.au'>Email</a>)")),
                      helpText(HTML("<a href = 'https://researchers.adelaide.edu.au/profile/bree.bennett'> Dr Bree Bennett </a>, Senior Lecturer, School of Architecture and Civil Engineering, University of Adelaide (<a href='bree.bennett@adelaide.edu.au'>Email</a>)"))
             ),
             ...
             tabPanel("Help / About",
                      helpText(h3("Help")),
                      helpText(HTML("Please report any bugs, issues or feature requests to <a href='https://github.com/AdWater/ProbApp/issues'> https://github.com/AdWater/ProbApp/issues </a>")),
                      helpText(h3("Licenses, Warranty and Disclaimer")),
                      helpText(HTML("This open source project is provided under the <a href='https://www.gnu.org/licenses/gpl-3.0.en.html'> GPLv3 license</a>. Please see link for terms covering warranty, disclaimers, liability and use of this software.")),
                      helpText(h3("References")),
                      helpText(h4("Residual error model development")),
                      helpText(HTML("Hunter, J., Thyer, M., McInerney, D. & Kavetski, D. 2020. Achieving high-quality probabilistic predictions from hydrological models calibrated with a wide range of objective functions. <i> Journal of Hydrology </i>, vol 603, DOI: <a href = 'https://doi.org/10.1016/j.jhydrol.2021.126578'> https://doi.org/10.1016/j.jhydrol.2021.126578 </a>.")),
                      ...
                      helpText(HTML("McInerney, D., Thyer, M., Kavetski, D., Laugesen, R., Woldemeskel, F., Tuteja, N., & Kuczera, G., 2022. Seamless streamflow forecasting at daily to monthly scales: MuTHRE lets you have your cake and eat it too, <i> Hydrol. Earth Syst. Sci. </i>, 26, 5669–5683, DOI: <a href = 'https://doi.org/10.5194/hess-26-5669-2022'> https://doi.org/10.5194/hess-26-5669-2022 </a>")),
                      helpText(HTML("McInerney, D., Thyer, M., Kavetski, D., Laugesen, R., Woldemeskel, F., Tuteja, N., & Kuczera, G., 2021. Improving the reliability of sub-seasonal forecasts of high and low flows by using a flow-dependent nonparametric model. <i> Water Resources Research </i>, 57, e2020WR029317, DOI: <a href 'https://doi.org/10.1029/2020WR029317'> https://doi.org/10.1029/2020WR029317 </a>")),
